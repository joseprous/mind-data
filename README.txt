...
- No. But the idea is to provide a minimalist fully-functional set of contents so others can use this as a base for starting their own games.
...
- Even when most of the game and engine source code were relesed under GPL, all the game content remain propietary. Therefore it is necessary to provide some basic content in order to use the engine in a fully GPL way.

Do I have to pay for it?

- No. This is free as in free-dog-shit. We want you to get even if you don't know you did ;).
